...
function run(overrides: Partial<RunView> = {}): RunView {
  return {
    ...
    decisions: [{ decisionId: "decision-1", runId: "run-1", candidateId: "candidate-1", aRowId: "A1", bRowId: "B1", systemProposal: "needs_review", humanDecision: "same_entity", matcherVersion: "explainable-matcher-v0.2.0", evidenceShown: [evidence], decidedAt: "2026-01-01T00:00:00Z" }],
