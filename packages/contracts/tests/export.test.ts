...
describe("run manifest contract", () => {
  it("validates the versioned machine-readable export manifest", () => {
    const manifest = RunManifestSchema.parse({
      ...
      candidateGeneration: { candidateEngineVersion: "candidate-engine-v0.4.0", blockingNormalizationVersion: "blocking-normalization-v0.1.0", candidateConfigVersion: "candidate-engine-v0.4.0", candidateConfigAvailability: "retained_in_evidence_plan", evidencePlanVersion: "evidence-plan-v1.0.0", evidencePlanSha256: "a".repeat(64), evidencePlan: {} },
      matcher: { featurePipelineVersion: "feature-pipeline-v0.2.0", matcherVersion: "explainable-matcher-v0.3.0", matcherConfigVersion: "matcher-config-v0.3.0", matcherConfig: {}, scoreSemanticsVersion: "explainable-matcher-v0.3.0" },
      identity: { systemEstablishedLinkCount: 0, humanSameCount: 0, humanDifferentCount: 0, pendingCount: 1, deferredCount: 0, collisionRelatedCount: 0, humanBatchPairCount: 0, reviewSignatureVersion: "review-signature-v1.0.0" },
